...
import { pointAtIndex, ROUTE_LENGTH, VIEW } from "../../src/components/humanAdvantage/ascent/route";
import { GATE_DEFS } from "../../src/components/humanAdvantage/ascent/AscentMapHero";
