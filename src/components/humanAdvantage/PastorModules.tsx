...
export function PastorOpeningBlock({ result }: { result: HumanAdvantageResult }) {
  return (
...
export function ServingAndStandingIn({ result }: { result: HumanAdvantageResult }) {
...
export function DependenceCheckBlock({ result }: { result: HumanAdvantageResult }) {
...
export function OutageReading({ result }: { result: HumanAdvantageResult }) {
...
export function FaithfulnessAndIntegrity({ result }: { result: HumanAdvantageResult }) {
...
export function PastorSignature({ result }: { result: HumanAdvantageResult }) {
...
export function FormationRoadmap({ result }: { result: HumanAdvantageResult }) {
 ...
 */
const LIBRARY: Array<{ id: string; cite: string; offers: string; when: (r: HumanAdvantageResult) => boolean }> = [
  {
    id: 'faith-at-work',
...
export function PastorResources({ result }: { result: HumanAdvantageResult }) {
...
const REFLECTIONS: Array<{
  ...
  when: (r: HumanAdvantageResult) => boolean;
}> = [
  {
    id: 'dependence',
...
export function PastorReflections({ result }: { result: HumanAdvantageResult }) {
...
export function PastorCertificate({ result, name, takenAt }: {
  result: HumanAdvantageResult; name?: string;
