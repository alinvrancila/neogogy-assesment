...
import type { HumanAdvantageResult, RiskCategory } from '@/engine';
...
export function HealthHeadline({ result }: { result: HumanAdvantageResult }) {
  const verdict = (() => {
...
export function HelpingHarming({ result }: { result: HumanAdvantageResult }) {
...
/** 3. The Risk Register. */
export function RiskRegister({ result }: { result: HumanAdvantageResult }) {
...
export function ContinuityTest({ result }: { result: HumanAdvantageResult }) {
...
export function TrustAndGovernance({ result }: { result: HumanAdvantageResult }) {
...
export function DecisionIntegrity({ result }: { result: HumanAdvantageResult }) {
...
export function NinetyDayPlan({ result }: { result: HumanAdvantageResult }) {
 ...
 */
export function ScopedDimensions({ result, scope }: { result: HumanAdvantageResult; scope: Scope }) {
