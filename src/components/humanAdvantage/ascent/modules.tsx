 ...
 *
 * These are presentational. Every number arrives on the HumanAdvantageResult; none is
 ...
 */
const leanOf = (result: HumanAdvantageResult) =>
  riskLean(result.composites.dependencyIndex, result.composites.underexposure);

export function ResultHeader({ result }: { result: HumanAdvantageResult }) {
  return (
...
export function DevelopmentalIndex({ result }: { result: HumanAdvantageResult }) {
  return (
...
export function OrientationCard({ result }: { result: HumanAdvantageResult }) {
...
export function RouteStages({ result }: { result: HumanAdvantageResult }) {
...
export function PracticeGates({ result }: { result: HumanAdvantageResult }) {
  return (
...
export function FootholdCard({ result }: { result: HumanAdvantageResult }) {
  return (
...
export function RouteLogCard(
  { result, hasHistory = false }: { result: HumanAdvantageResult; hasHistory?: boolean }
) {
...
export function NextClimbCard({ result }: { result: HumanAdvantageResult }) {
