...
import type { HumanAdvantageResult, DimensionDetail } from '@/engine';
...
export function GateGap({ result }: { result: HumanAdvantageResult }) {
...
export function ThresholdStrip({ result }: { result: HumanAdvantageResult }) {
...
export function CalibrationScale({ result }: { result: HumanAdvantageResult }) {
...
export function PatternCards({ result, kind }: { result: HumanAdvantageResult; kind: 'help' | 'harm' }) {
