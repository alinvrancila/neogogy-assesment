 ...
 * generateReportSections(); all numbers come from the HumanAdvantageResult. Nothing
...
import {
  ...
  type HumanAdvantageResult, type ReportSection, type ReportSectionKey,
} from '@/engine';
...
function ConfidenceBanner({ result }: { result: HumanAdvantageResult }) {
...
function SectionBlock(
  { section, result, lead }: { section: ReportSection; result: HumanAdvantageResult; lead?: string }
) {
