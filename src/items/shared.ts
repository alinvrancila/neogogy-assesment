...
export function claim(persona: Persona, construct: ConstructId, prompt: string,
  ...
  return { id: `${persona}_${construct}_claim`, persona, type: "claim", construct,
    prompt, scale, pairId: `${persona}_${construct}`, version: 2, ...opts };
}
...
export function reverse(persona: Persona, construct: ConstructId, prompt: string,
  ...
  return { id: `${persona}_${construct}_rev`, persona, type: "reverse", construct,
    prompt, scale, riskSignal, version: 2, ...opts };
}
...
export function scenario(persona: Persona, construct: ConstructId, prompt: string,
  ...
  return { id: `${persona}_${construct}_s`, persona, type: "scenario", construct,
    prompt, options, riskSignal, pairId: `${persona}_${construct}`, version: 2, ...rest };
}
...
export const OUTCOME_ITEMS: Item[] = [
  ...
  { id: "out_persist", persona: "shared", type: "outcome", construct: "skillGrowth",
    ...
    prompt: "Compared with before I used AI regularly, the time I spend wrestling with a hard problem before seeking help has...",
...
export const LOW_USE_REASON: Item = {
  ...
  options: [
    { value: 1, label: "I know these tools reasonably well and deliberately limit where I use them." },
...
export const HIGH_USE_PROBES: Item[] = [
  { id: "highuse_outage", persona: "shared", type: "scenario", construct: "dependencySafety",
    ...
    options: [
      ...
      { value: 5, label: "No difference, and it has not happened in a way I feared, because I keep unaided practice in my routine." },
    ], version: 2 },
